...
namespace DatabaseTools.Configuration.Preferences
{
    public class ConnectionSettingsContext
    {
        ...
        private static System.Configuration.Configuration GetConfiguration()
        {
            ...
            ConnectionSettingsPath = System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "DatabaseTools");
        ...
        {
            return System.IO.Path.Combine(ConnectionSettingsPath, "databaseTools.config");
        }
