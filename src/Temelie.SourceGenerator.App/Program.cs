...
await fileGenerator.GenerateEntityFrameworkCoreAsync(Path.Combine(DirectoryConfig.RepoDirectory, "Temelie.sln"), "AdventureWorks.Entities", "AdventureWorks.Server.Repository.EntityFrameworkCore");
